...
```{r African_children, fig.width=9, fig.height=7}
...
```{r pigmented_neutrophils_5percent, fig.height=7, fig.width=7}
...
mod=metabin(event.e = event_e, n.e = n_e,event.c = event_c,
            n.c = n_c, studlab = lab,method = 'GLMM',
            sm = 'OR',
            comb.random = T)
par(family='serif')
...
forest(mod, lab.e = '>5% pPMN', lab.c = '<5% pPMN',
       ...
       digits.pval=1, scientific.pval=T)
```
Difference between children and adults? (which is a difference between high and low transmission settings)
